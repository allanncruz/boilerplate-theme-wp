...
function contact_informations_customize_register($wp_customize)
{
    ...
    $wp_customize->add_control(new WP_Customize_Control($wp_customize, 'linkedin_username', array(
    ...
    $wp_customize->add_setting('mail_address', array(
        'default'   => 'contato@oncologiaemastologia.com',
        'transport' => 'refresh',
    ));
